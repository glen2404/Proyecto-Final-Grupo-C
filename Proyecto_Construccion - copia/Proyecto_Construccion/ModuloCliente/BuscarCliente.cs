...
namespace CapaVisual
{
    public partial class BuscarCliente : Form
    {
        ...
        {
            string query = "SELECT * FROM Cliente"; // Consulta SQL para obtener datos
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Crear una instancia de ManageCliente
                ManageCliente manageCliente = new ManageCliente();

                // Obtener el cliente por cédula
                DataTable dt = manageCliente.ObtenerCliente(cedula);
                ...
                else
                {
                    ...
                    MessageBox.Show("No se encontró ningún cliente con la cédula proporcionada.", "Resultado de Búsqueda", MessageBoxButtons.OK, MessageBoxIcon.Information);
